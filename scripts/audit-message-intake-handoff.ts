...
process.stdout.write(`${JSON.stringify({ statePathHash: auditResourceHash(statePath), mode: 'read-only', ...handoff.counts, checkpoint: handoff.checkpoint, digest: handoff.digest }, null, 2)}\n`)
