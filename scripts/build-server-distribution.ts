...
try {
  ...
  await bundle(sourceRoot, 'src/control-plane/cloud-server-entry.ts', join(root, 'program/dist/control-plane/cloud-server-entry.js')); await bundle(sourceRoot, 'src/client-runtime/ssh-subsystem-entry.ts', join(root, 'program/dist/client-runtime/ssh-subsystem-entry.js'))
