...
test('prepares privacy-bounded idempotent session lifecycle workflows', async () => {
  ...
  }, { deleteAfterDays: 7, authorization }, '2026-08-24T00:00:00Z')
  ...
  assert.throws(() => prepareSessionLifecycleHandoff({ mentionResearchSessions: [{ sessionId: 'unsafe', taskId: 'task' }] }, { authorization },
