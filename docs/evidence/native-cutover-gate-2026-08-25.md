...
采集时间：`2026-08-25T05:40:56Z`
代码版本：`f4293daa24ca62e5ccc553e384b4afb1aec7ec42`
...
- 189 条决策、82 个 matter、26 个任务快照、3 条反馈；
- 182 条完整 source/context、7 条 durable receipt、0 条无来源决策；
- 19 条差异、45 次任务变更；
...
- 278 个 result 文件，其中 171 个 task projection；
- 148 个 current-schema 严格接受样本，超过最少 20 条门槛；
- 分布为 ignored 62、created 12、unchanged 64、updated 10；
- 接受窗口 `2026-08-23T09:59:59.954Z` 至 `2026-08-25T05:38:24.987Z`；
